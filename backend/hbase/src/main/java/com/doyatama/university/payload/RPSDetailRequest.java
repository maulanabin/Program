...
public class RPSDetailRequest {
    ...
    public RPSDetailRequest(String rps_id, Integer week, String sub_cp_mk, List<String> learning_materials, String form_learning_id, List<String> learning_methods, List<String> assignments, List<String> estimated_times, List<String> student_learning_experiences, List<String> assessment_criterias, List<String> appraisal_forms, List<String> assessment_indicators, Float weight) {
        this.rps_id = rps_id;
        this.week = week;
