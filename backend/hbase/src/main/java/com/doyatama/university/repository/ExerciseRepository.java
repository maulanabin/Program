...
public class ExerciseRepository {
    ...
    public List<Exercise> findAllByProdi(String studyProgramId, int size) throws IOException {
        HBaseCustomClient client = new HBaseCustomClient(conf);
        ...
        columnMapping.put("date_end", "date_end");
        columnMapping.put("created_at", "created_at");
        return client.getDataListByColumn(tableUsers.toString(), columnMapping, "detail", "study_program", studyProgramId, Exercise.class, size);
    }
    ...
    public Exercise save(Exercise exercise) throws IOException {
        ...
        client.insertRecord(tableExercise, rowKey, "detail", "study_program", exercise.getRps().getStudy_program().getId());
        return exercise;
    }
    ...
    public Exercise update(String exerciseId, Exercise exercise) throws IOException {
        ...
        client.insertRecord(tableExercise, exerciseId, "detail", "study_program", exercise.getRps().getStudy_program().getId());
        return exercise;
    }
